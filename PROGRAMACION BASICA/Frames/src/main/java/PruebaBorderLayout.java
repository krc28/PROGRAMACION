 ...
 * El programa es un Applet, pero tambi�n dispone de m�todo main() para ejecutarlo como
 * aplicaci�n independiente.
 *
 * @author Chuidiang
 */
public class PruebaBorderLayout extends JApplet
{
    ...
    /**
     * main para ejecutar como aplicaci�n independiente.
     *
    ...
    /**
     * Construye el panel superior meti�ndole cinco botones.
