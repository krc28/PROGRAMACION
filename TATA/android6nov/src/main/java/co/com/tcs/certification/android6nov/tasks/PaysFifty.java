...
public class PaysFifty implements Task {
    private String name;
    private String phone;
    private String country;
    private String pay;

    public PaysFifty(List<UserModel> login) {
    ...
    public static PaysFifty paysFifty(List<UserModel> login){
        return Tasks.instrumented(PaysFifty.class, login);
    }
}
